<?php
    session_start();
    include 'php/registers_for_admin.php';
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="local-container page-fade">
            <div id="home" class="align-center flex-column scrollable">
                ...
                hourArray.forEach((element) => {
                    element.addEventListener('click', () => {
                        if(element.innerText == "") {
                            ...
                            window.location.href = `receipt_for_admin.php?hour=${element.innerText}&date=<?php echo $_GET['date']; ?>&cpf=<?php echo $_GET['cpf'] ?>&name=<?php echo $_GET['name'] ?>`;
                        }
                    });
                });
